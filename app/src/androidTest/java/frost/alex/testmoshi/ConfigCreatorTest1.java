...
public class ConfigCreatorTest1 {
    ...
    public void test1MoshiAdapter() throws Exception {
        ...
        Log.d("test", String.format("Moshi adapter takes %d us", (t1 - t0) / 1000));
    }
    ...
    public void testMoshiJsonValue() throws Exception {
        ...
        Log.d("test", String.format("Moshi json value takes %d us", (t1 - t0) / 1000));
    }
    ...
    public void testGsonJsonObject() throws Exception {
        ...
        Log.d("test", String.format("Gson json value takes %d us", (t1 - t0) / 1000));
    }
